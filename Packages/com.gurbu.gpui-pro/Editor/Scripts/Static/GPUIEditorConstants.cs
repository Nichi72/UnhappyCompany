...
namespace GPUInstancerPro
{
    public static class GPUIEditorConstants
    {
        ...
        {
            public static readonly string showHelpTooltip = "도움말 표시";
            public static readonly string hideHelpTooltip = "도움말 숨기기";
            public static readonly string isShaderVariantCollection = "셰이더 변형 컬렉션 생성";
