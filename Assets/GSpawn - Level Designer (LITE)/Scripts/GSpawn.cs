...
namespace GSpawn_Lite
{
    ...
    public class GSpawn : MonoBehaviour
    {
        ...
        public static string    currentVersion              { get { return "1.0.2"; } }

        [MenuItem("Tools/GSpawn (LITE)/Initialize", false, _menuItemPriorityStart_Initialize)]
        ...
        [MenuItem("Tools/GSpawn (LITE)/Actions/Select-Deselect &R", false, _menuItemPriorityStart_Actions)]
        ...
        [MenuItem("Tools/GSpawn (LITE)/Actions/Transfer Selection &T", false, _menuItemPriorityStart_Actions + 1)]
        ...
        [MenuItem("Tools/GSpawn (LITE)/Actions/Refresh Data Caches", false, _menuItemPriorityStart_Actions + 2)]
        ...
        [MenuItem("Tools/GSpawn (LITE)/Actions/Refresh Prefab Previews", false, _menuItemPriorityStart_Actions + 3)]
        ...
        [MenuItem("Tools/GSpawn (LITE)/Windows/Prefab Library Manager...", false, _menuItemPriorityStart_Prefabs + 1)]
        ...
        [MenuItem("Tools/GSpawn (LITE)/Windows/Prefab Manager...", false, _menuItemPriorityStart_Prefabs + 2)]
        ...
        [MenuItem("Tools/GSpawn (LITE)/Windows/Random Prefabs...", false, _menuItemPriorityStart_Prefabs + 3)]
        ...
        [MenuItem("Tools/GSpawn (LITE)/Windows/Integer Range Prefabs...", false, _menuItemPriorityStart_Prefabs + 4)]
        ...
        [MenuItem("Tools/GSpawn (LITE)/Windows/Integer Patterns...", false, _menuItemPriorityStart_Misc)]
        ...
        [MenuItem("Tools/GSpawn (LITE)/Windows/Object Layers...", false, _menuItemPriorityStart_Misc + 1)]
        ...
        [MenuItem("Tools/GSpawn (LITE)/Windows/Object Groups...", false, _menuItemPriorityStart_Misc + 2)]
        ...
        [MenuItem("Tools/GSpawn (LITE)/Windows/Grid Settings...", false, _menuItemPriorityStart_Misc + 3)]
        ...
        [MenuItem("Tools/GSpawn (LITE)/Windows/Shortcuts...", false, _menuItemPriorityStart_Misc + 4)]
        ...
        [MenuItem("Tools/GSpawn (LITE)/Windows/Mesh Combine...", false, _menuItemPriorityStart_Misc + 5)]
        ...
        [MenuItem("Tools/GSpawn (LITE)/Windows/Export Data...", false, _menuItemPriorityStart_Data)]
