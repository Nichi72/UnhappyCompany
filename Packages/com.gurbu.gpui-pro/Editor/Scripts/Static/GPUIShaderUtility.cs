    ...
    public static class GPUIShaderUtility
    {
        ...
        private static string AddIncludeAndPragmaDirectives(string includePath, string newShaderText, string setupText, bool doubleEscape, string extensionCode, string shaderDirectory, string setupEndText)
        {
            ...
            while (true)
            {
                ...
                searchOffset = ProcessShaderPass(ref newShaderText, additionTextEnd, rpInclude, blockStartIndex, blockEndIndex, blockText, extensionCode, shaderDirectory, newLineString, setupEndText, out bool isSuccessful);
                if (!isSuccessful)
                    return null;
