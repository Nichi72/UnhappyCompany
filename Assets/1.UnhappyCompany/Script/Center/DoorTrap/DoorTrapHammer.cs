...
public class DoorTrapHammer : MonoBehaviour
{
    ...
    public void On()
    {
        ...
        if (isOnProcessing)
        {
            ...
            AudioManager.instance.Play3DSoundByTransform(FMODEvents.instance.trapHammerAlreadyActive, gameObject.transform, 20f, "해머 트랩이 이미 실행 중입니다.");
            return;
        }
        ...
        if (count <= 0)
        {
            ...
            AudioManager.instance.Play3DSoundByTransform(FMODEvents.instance.trapHammerLimitExceeded, gameObject.transform, 20f, "해머 트랩 발사 횟수를 초과했습니다.");
            return;
        }
        ...
        AudioManager.instance.Play3DSoundByTransform(FMODEvents.instance.trapHammerStrike, gameObject.transform, 40f, "해머 트랩 작동 소리. 무거운 해머가 내려치는 듯한 강력한 타격음. 쾅! 하는 느낌의 임팩트 있는 소리.");
    }
